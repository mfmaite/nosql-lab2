const { ciAlreadyExists, createPatient, createPatientRegistry } = require('../services/pacientes');
...
module.exports = { crearPaciente, consultarHistoria, crearRegistroPaciente };
